...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit->setGeometry(QRect(20, 10, 311, 21));
        addBtn = new QPushButton(centralwidget);
        addBtn->setObjectName("addBtn");
        addBtn->setGeometry(QRect(370, 0, 100, 32));
        listWidget = new QListWidget(centralwidget);
        listWidget->setObjectName("listWidget");
        listWidget->setGeometry(QRect(20, 60, 461, 501));
        removeBtn = new QPushButton(centralwidget);
        removeBtn->setObjectName("removeBtn");
        removeBtn->setGeometry(QRect(260, 570, 100, 32));
        removeAllBtn = new QPushButton(centralwidget);
        removeAllBtn->setObjectName("removeAllBtn");
        removeAllBtn->setGeometry(QRect(390, 570, 100, 32));
